  ...
  return (
    <>
        ...
        <main>
            ...
            <section>
                <h1 className="text-7xl text-center mt-5 text-[#2061b7]">35-100V to 24V Series</h1>

                <section className="grid grid-cols-2 gap-0 py-5 px-5 justify-items-center my-5">
                    <section>
                        <img src="/Products/isolated-dc-dc/product/1.jpg" alt="35-100V to 5V Series" className="w-full"/>
                    </section>

                    <section className="p-4">
                        <h1 className="text-3xl font-semibold text-center">35-100V to 24V Isolated DC-DC Power Converters</h1>
                        ...
                        <button className="text-xl font-medium text-center bg-[#000] text-white px-5 py-3 rounded-xl cursor-pointer mt-4 w-full self-end">Add to Cart</button>
                    </section>
                </section>

                <section className="table mx-auto my-5">
                    <h1 className="text-3xl font-semibold text-center">35-100V to 24V Series Specifications</h1>
